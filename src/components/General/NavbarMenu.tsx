      ...
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        <div className="flex items-center gap-2 text-green-600">
          <div className="flex flex-col text-xl font-semibold whitespace-nowrap tracking-widest">
            ...
            <span className="flex items-center gap-3 font-thin">
              MONEY? <Receipt size={20} weight="fill" />
            </span>
          </div>
        </div>
        <div className="flex gap-10 z-10">
          {theme === "light" ? (
            <button
              className="text-[#52525b] hover:text-blue-500 transition-colors"
            ...
            <button
              className="text-[#52525b] hover:text-yellow-400 transition-colors"
          ...
          >
            ...
            <Dropdown.Divider /> */}
            <Dropdown.Item onClick={auth.Logout}>Sair</Dropdown.Item>
          </Dropdown>
        </div>
      </div>
    </nav>
